        ...
        <div className="relative flex flex-col h-full bg-[#FFF] shadow-md md:w-[350px] xl:w-[310px] lg:w-[280px] w-[320px] lg:p-[30px_30px_30px_30px]  p-[20px_20px_20px_20px] sidebar overflow-hidden">
                ...
                {navItems.map((item, index) => {
                    ...
                    return item.hasDropdown ? (
                        <div key={index} className={`flex flex-col w-full p-[6px] rounded-[18px] transition-colors ${isDropdownOpen ? 'bg-[#DFD3EB]' : isActiveParent ? 'bg-[#DFD3EB]' : 'bg-transparent hover:bg-[#DFD3EB]'}`}>
                            ...
                            >
                                <div className="flex items-center gap-[10px]">
                                    <div
                                        className={`flex items-center justify-center w-[46px] h-[46px] rounded-[12px] ${isActiveParent || isDropdownOpen ? "bg-gradient-to-r from-[#7B4DDB] to-[#9B6BFF]" : "bg-[#fff] shadow-[0px_1px_4px_rgba(0,0,0,0.16)]"}`}
                                    >
                                    ...
                                    {item.subItems.map((subItem, subIndex) => {
                                            ...
                                            subItem.path === "/useraccount"
                                                ...
                                                : subItem.path === "/developeraccount"
                                                    ...
                                                    : subItem.path === "/agencyaccount"
                                                        ? ["/agencyaccount", "/agencyaccountdetail"]
                                        ...
                                        return (
                                            <NavLink
                                                ...
                                                to={subItem.path}
                                                onClick={() => setIsDrawerOpen(false)}
                                                className={`flex items-center justify-start w-full px-[20px] py-[16px] rounded-[12px] text-[13px] font-[Medium] transition-colors ${looksActive ? "bg-[#6A3CA8] text-[#fff]" : "bg-[#fff] text-[#222] hover:bg-[#F5F5F5]"
                                                    }`}
                                            >
                                                {subItem.label}
                                            </NavLink>
                        ...
                        <NavLink
                            ...
                            className={() =>
                                `flex w-full gap-[10px] items-center justify-start rounded-[15px] p-[6px] transition hover:bg-[#DFD3EB] focus:outline-none focus:border-none focus:shadow-none ${isItemActive ? " bg-[#DFD3EB]  " : "bg-transparent "
                                }`
                            }
                            onClick={() => {
                                setIsDrawerOpen(false);
                        ...
                        >
                            <div
                                className={`flex items-center justify-center w-[46px] h-[46px] rounded-[12px] ${isItemActive ? "bg-gradient-to-r from-[#7B4DDB] to-[#9B6BFF]" : "bg-[#fff] shadow-[0px_1px_4px_rgba(0,0,0,0.16)]"}`}
                            >
                                <item.icon
            ...
            {/* <div className="pt-[20px] mt-auto border-t border-[rgba(34,34,34,0.10)]">
                <p className="text-[12px] leading-[1.5] text-[#707070] font-[Regular]">
                    Copyright © 2025 propertyfinder.ae.
                </p>
                <p className="text-[12px] leading-[1.5] text-[#707070] font-[Regular]">
                    All rights reserved.
                </p>
