...
const PasswordOtpModal: React.FC<PasswordOtpModalProps> = ({ isOpen, onClose, onVerifyOtp }) => {
            ...
            <div className="relative bg-white w-full md:max-w-[560px]  h-auto max-h-[90vh] rounded-t-2xl md:rounded-[24px] flex flex-col  transform transition-all duration-300">
                ...
                <div className="md:p-[0px_50px_60px_50px] p-[0px_20px_30px_20px]">
                    <div className="flex flex-col items-center text-center">
                        <img src={logo} alt="Property Finder" className="w-[138px] mb-[31px]" />
                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${isOtpComplete
                                    ? "bg-[#6A3CA8] text-white cursor-pointer"
                                    : "bg-[#6A3CA8] text-white opacity-[0.4] cursor-not-allowed"
                                }
                            `}
                        >
                            Verify OTP
                        ...
                        <div className="flex items-center justify-center gap-[8px] text-[28px]">
                            ...
                            <button type="button" className="cursor-pointer font-[Bold] text-[#6A3CA8] text-[14px]">
                                Resend it
                            </button>
                        </div>
                    </div>
