...
function AgentAccountDetail() {
    const navigate = useNavigate();
    const fileInputRef = useRef<HTMLInputElement>(null);
    // useState
    const [isAgentTypeDropdownOpen, setIsAgentTypeDropdownOpen] =
        useState(false);
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (
                ...
                !agentTypeDropdownRef.current.contains(
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[20px]">
                    ...
                    <div>
                        <label className="text-[14px] font-[SemiBold] text-[#222] block mb-[6px]">
                            Full Name <span className="text-[#EA3934]">*</span>
                        </label>
                    ...
                    <div>
                        ...
                        <div className="relative w-full" ref={agentTypeDropdownRef}>
                            ...
                            >
                                <h4 className="text-[13px] font-[Medium] text-[#222] truncate capitalize">
                                    {selectedAgentType}
                                </h4>

                                <DownArrowIcon
                                    className={`mt-[2px] transition-transform ${isAgentTypeDropdownOpen
                                        ? "rotate-180"
                                        : ""
                                        }`}
                                    width={14}
                            ...
                            {isAgentTypeDropdownOpen && (
                                <div className="absolute top-[50px] left-0 w-full bg-white border border-[#EAEAEA] rounded-[10px] shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-10 overflow-hidden py-[8px]">
                                    ...
                                    {["agent", "superagent"].map((type) => (
                                        <div
                                            key={type}
                                            className={`flex items-center px-[14px] py-[10px] cursor-pointer hover:bg-[#F5F5F5] ${selectedAgentType === type
                                                ? "bg-[#F5F5F5]"
                                                : ""
                                                }`}
                                            onClick={() => {
                    ...
                    {/* About Me  md:col-span-2 xl:col-span-3*/}
                    ...
                    {/* Agency Logo Upload */}
                    <div className="md:col-span-2 xl:col-span-3 bg-[#fff] p-[20px] rounded-[12px] shadow-[0px_1px_0px_rgba(17,17,26,0.05),0px_0px_8px_rgba(17,17,26,0.10)] mt-[5px]">
